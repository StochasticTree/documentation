...
The "classic" BART model of @chipman2010bart models every outcome observation $y_i$ as i.i.d. normal with a mean $f(x_i)$ expressed as a function of covariates $x_i$ and global error variance $\sigma^2$ with an inverse-gamma prior.
