...
look at individual trees, starting with the first tree in the last "grow-from-root"
sample.
...
This tree has a single split on the only "important" feature. Now, let's look at
the second tree.
